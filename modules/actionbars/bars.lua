...
SocialsMicroButton:SetScale(0.0001)
SocialsMicroButton:EnableMouse(false)
...
for i=1, num do
	...
	if isBeautiful then
		...
		button:SetBeautyBorderTexture(cfg.BorderTexture)
	end
	if i == 1 then
...
for _, button in pairs(bagbuttonList) do
	...
	if not cfg.bag.enable then
		button:Hide() --kinda a cheesey way to hide this byut hey it does what it's supposed to to
	end
end
